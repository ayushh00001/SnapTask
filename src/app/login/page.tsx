...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex">
      <div className="flex-1 flex items-center justify-center px-6 bg-white dark:bg-notion-bg">
        <div className="max-w-sm w-full">
          ...
          <div className="mt-6 space-y-3">
            <Button variant="secondary" className="w-full flex items-center justify-center gap-2" onClick={() => handleOAuth('google')} loading={loading}>
            ...
            <Button variant="secondary" className="w-full flex items-center justify-center gap-2" onClick={() => handleOAuth('github')} loading={loading}>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center"><span className="px-3 text-xs text-text-muted bg-white dark:bg-notion-bg">or continue with email</span></div>
          </div>
